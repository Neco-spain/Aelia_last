...
public final class Config
{
	...
	public static int KARMA_DROP_LIMITVIP;
	public static int KARMA_RATE_DROPVIP;
	public static int KARMA_RATE_DROP_ITEMVIP;
	public static int KARMA_RATE_DROP_EQUIPVIP;
	public static int KARMA_RATE_DROP_EQUIP_WEAPONVIP;
	...
	public static boolean CUSTOM_DEVELOPER;
...
*/
	public static int CLIENT_PACKET_QUEUE_SIZE = 82; // default MMO_MAX_READ_PER_PASS + 2
	public static int CLIENT_PACKET_QUEUE_MAX_BURST_SIZE = 81; // default MMO_MAX_READ_PER_PASS + 1
	public static int CLIENT_PACKET_QUEUE_MAX_PACKETS_PER_SECOND = 160; // default 160
	public static int CLIENT_PACKET_QUEUE_MEASURE_INTERVAL = 5; // default 5
	public static int CLIENT_PACKET_QUEUE_MAX_AVERAGE_PACKETS_PER_SECOND = 80; // default 80
	public static int CLIENT_PACKET_QUEUE_MAX_FLOODS_PER_MIN = 4; // default 2
	public static int CLIENT_PACKET_QUEUE_MAX_OVERFLOWS_PER_MIN = 2; // default 1
	public static int CLIENT_PACKET_QUEUE_MAX_UNDERFLOWS_PER_MIN = 2; // default 1
	public static int CLIENT_PACKET_QUEUE_MAX_UNKNOWN_PER_MIN = 80; // default 5
	...
	private static final void loadServer()
	{
		...
		KARMA_DROP_LIMITVIP = server.getProperty("KarmaDropLimitVIP", 10);
		KARMA_RATE_DROPVIP = server.getProperty("KarmaRateDropVIP", 70);
		KARMA_RATE_DROP_ITEMVIP = server.getProperty("KarmaRateDropItemVIP", 50);
		KARMA_RATE_DROP_EQUIPVIP = server.getProperty("KarmaRateDropEquipVIP", 40);
		KARMA_RATE_DROP_EQUIP_WEAPONVIP = server.getProperty("KarmaRateDropEquipWeaponVIP", 10);
		...
		CUSTOM_DEVELOPER = server.getProperty("CustomDeveloper", false);
